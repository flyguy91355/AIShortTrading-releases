...
feature as AITrading's own -- see that project's CLAUDE_HISTORY.md 2026-08-21 entry for
the full design, and owner request: "backfeed it with the data too whatever you can").
...
report has a real value for it).
