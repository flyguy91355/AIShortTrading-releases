...
class TradeSignal:
    ...
    # The exact R/R and its required gate at the moment THIS signal cleared to short
    # (2026-08-21) -- not recomputed later, so Position.buy_rr/buy_required_rr (see
    # that field's own docstring) reflect the real numbers that allowed the trade, not
    # a reconstruction from possibly-since-changed data. None for a sell signal or any
    # construction site that predates this field.
    rr: float | None = None
